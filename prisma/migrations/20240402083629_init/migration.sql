...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_produccerId_fkey" FOREIGN KEY ("produccerId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
